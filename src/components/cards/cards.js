...
import { MDBContainer, MDBRow, MDBCol, MDBCard, MDBCardBody, MDBCardImage, MDBIcon, MDBBtn, MDBRipple, } from "mdb-react-ui-kit";
...
const Cards = ({data}) => {
    ...
    data&&
        data.map((item) => (
            ...
            <MDBCol xl="3" sm='12' md="6" lg="4" className="mb-4 ">
        <MDBCard className=''>
        <MDBRipple
          rippleColor="light"
          rippleTag="div"
